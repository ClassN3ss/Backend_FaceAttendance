...
exports.saveFaceImagesToModel = async (req, res) => {
  try {
    ...
    // เรียก model
    const response = await axios.post("https://face-api-md-68c2ebde79ed.herokuapp.com/api/verify-face", form, {
...
exports.saveTeacherFace = async (req, res) => {
  try {
    ...
    const MODEL_BASE_URL = process.env.MODEL_BASE_URL || 'https://face-api-md-68c2ebde79ed.herokuapp.com';
    const form = new FormData();
